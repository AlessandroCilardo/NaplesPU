...
set_property -dict {PACKAGE_PIN K15 IOSTANDARD LVCMOS33} [get_ports ddr_calib_done]
set_property -dict {PACKAGE_PIN J13 IOSTANDARD LVCMOS33} [get_ports uart_overrun]
set_property -dict {PACKAGE_PIN N14 IOSTANDARD LVCMOS33} [get_ports uart_frame_error]
set_property -dict {PACKAGE_PIN R18 IOSTANDARD LVCMOS33} [get_ports reset_out]
